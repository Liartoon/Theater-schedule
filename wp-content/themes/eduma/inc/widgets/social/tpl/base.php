...
if ( $show_label ) {
	$text_face      = esc_html__( 'Vkontakte', 'eduma' );
...
<div class="thim-social<?php echo esc_attr( $style ); ?>">
	...
	<ul class="social_link">
		<?php
		if ( $link_face != '' ) {
			echo '<li><a class="vkontakte hasTooltip" href="' . $link_face . '" target="' . $instance['link_target'] . '"><i class="fa fa-vk" aria-hidden="true"></i>'.$text_face.'</a></li>';
		}
		if ( $link_twitter != '' ) {
