...
//var_dump($theme_options_data['group_sharing']);
		...
		if ( $facebook || $twitter || $pinterest || $google || $linkedin ) {
			...
			if ( $twitter ) {
				echo '<li><div class="twitter-social"><a target="_blank" class="twitter" href="https://vk.com/share.php?url=' . urlencode( get_permalink() ) . '&amp;text=' . rawurlencode( esc_attr( get_the_title() ) ) . '" title="' . esc_attr__( 'Twitter', 'eduma' ) . '"><i class="fa fa-vk"></i></a></div></li>';
