...
<div class="lp-course-buttons">
    ...
    <form name="purchase-course" class="purchase-course form-purchase-course <?php echo $guest_checkout;?>" method="post" enctype="multipart/form-data">
        ...
        <button class="lp-button button button-purchase-course">
            ...
            <?php
           if((in_category('vzroslye-kotorym-nuzhna-pomoshh')) || (in_category('deti-kotorym-nuzhna-pomoshh')))
           {
echo esc_html( apply_filters( 'learn-press/purchase-course-button-text', __( 'Buy this course', 'eduma' ) ) ); 
            }
